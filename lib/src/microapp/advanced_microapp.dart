...
import 'package:advanced_search/src/features/data/repositories/manga_repository_imp.dart';
import 'package:advanced_search/src/features/data/repositories/search_repository_imp.dart';
...
import 'package:advanced_search/src/features/domain/usecases/get_popular_genres_use_case_imp.dart';
import 'package:advanced_search/src/features/presenter/ui/pages/search_page.dart';
...
class AdvancedMicroApp extends MicroApp {
  ...
  void registerDependencies() {
    ...
    getIt.registerFactory<MangaRepository>(
      () => MangaRepositoryImp(getIt(), getIt(), getIt()),
    );
